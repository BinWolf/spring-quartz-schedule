...
#jvm options
JAVA_OPTS="-Xms512m -Xmx2048m -Djava.awt.headless=true -XX:MaxPermSize=128m"
...
start() {
   ...
   if [ $psid -ne 0 ]; then
      ...
      JAVA_CMD="nohup $JAVA_HOME/bin/java $JAVA_OPTS -classpath $CLASSPATH $APP_MAINCLASS >/tmp/mcontrol/schedule_job.log 2>&1 &"
